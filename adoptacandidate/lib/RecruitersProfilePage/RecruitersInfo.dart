...
class RecruiterInfoPage extends StatefulWidget {

  @override
  State<RecruiterInfoPage> createState() => _RecruiterInfoPageState();
}

class _RecruiterInfoPageState extends State<RecruiterInfoPage> {
  bool _obscure1 = true;
