          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: (click == true) ?  const Color.fromRGBO(255, 255, 255, 0.2) : Colors.green,
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: (click2 == true) ?  const Color.fromRGBO(255, 255, 255, 0.2) : Colors.blue,
                  padding: const EdgeInsets.fromLTRB(18, 5, 0, 5),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(20),
                  ),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: (click3 == true) ?  const Color.fromRGBO(255, 255, 255, 0.2) : Colors.yellow,
                  padding: const EdgeInsets.fromLTRB(18, 5, 0, 5),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(20),
                  ),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: (click4 == true) ?  const Color.fromRGBO(255, 255, 255, 0.2) : Colors.purple,
                  padding: const EdgeInsets.fromLTRB(18, 5, 0, 5),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(20),
                  ),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: (click5 == true) ?  const Color.fromRGBO(255, 255, 255, 0.2) : const Color(0xFFFFD700),
                  padding: const EdgeInsets.fromLTRB(18, 5, 0, 5),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(20),
                  ),
